...
Access `Insights` via `sdk.insights()`, which returns `Result<Insights, OSTError>`. Resolve it once after identification and cache the reference. This protocol provides:
