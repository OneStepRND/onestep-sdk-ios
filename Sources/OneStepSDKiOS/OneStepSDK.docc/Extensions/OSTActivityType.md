...
Pass an `OSTActivityType` to ``OSTRecorder/start(activityType:duration:userInputMetadata:customMetadata:)`` to configure what kind of clinical assessment is being performed.
